use std::{task::Poll, rc::Rc, cell::RefCell};
...
pub struct BytesAsyncReader {
    source: Vec<u8>,
    cursor: usize,
    forced_pending: usize, // forced_pending represents the number of times this Reader will answer Pending for each poll_write (for testing repeated calls)
